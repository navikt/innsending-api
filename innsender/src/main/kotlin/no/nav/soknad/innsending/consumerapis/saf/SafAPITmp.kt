...
class SafAPITmp: SafInterface, HealthRequestInterface {
	...
	private val dummyArkiverteSoknader = mapOf (
		testpersonid to listOf (
			ArkiverteSaker(
				Utilities.laginnsendingsId(), "Test søknad", "BID", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format( OffsetDateTime.now().minusDays(7))
				, listOf(
			...
			ArkiverteSaker(
				Utilities.laginnsendingsId(), "Ettersending til test søknad", "BID", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format( OffsetDateTime.now().minusDays(2))
				, listOf(
			...
			ArkiverteSaker(
				Utilities.laginnsendingsId(), "Test søknad", "PEN", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format( OffsetDateTime.now().minusDays(14))
				, listOf(
		...
		ArkiverteSaker(
			...
			ArkiverteSaker(
				Utilities.laginnsendingsId(), "Ettersending til test søknad", "BID", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format( OffsetDateTime.now().minusDays(5))
				, listOf(
			...
			ArkiverteSaker(
				Utilities.laginnsendingsId(), "Ettersending til test søknad", "BID", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format( OffsetDateTime.now().minusDays(20))
				, listOf(
			...
			ArkiverteSaker(
				Utilities.laginnsendingsId(), "Ettersending til test søknad", "BID", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format( OffsetDateTime.now().minusDays(25))
			, listOf(
