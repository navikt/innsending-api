...
class TilleggsstonadServiceTest : InnsendingServiceTest() {
	...
	fun sendInnKjoreliste_tema_TSR() {
		...
		val hoveddokVariantDto = Hjelpemetoder.lagVedlegg(
			...
			erVariant = true,
			opplastingsStatus = OpplastingsStatusDto.LastetOpp,
			vedleggsNavn = "/__files/kjoreliste-NAV-11-12.24B-05032024.json" // tema=TSR
		)
		val inputDokumentSoknadDto = Hjelpemetoder.lagDokumentSoknad(
			skjemanr = kjoreliste,
			tittel = "Kjøreliste",
	...
	fun sendInnKjoreliste_tema_TSO() {
		...
		val hoveddokVariantDto = Hjelpemetoder.lagVedlegg(
			...
			erVariant = true,
			opplastingsStatus = OpplastingsStatusDto.LastetOpp,
			vedleggsNavn = "/__files/kjoreliste-NAV-11-12.24B-26032024.json" // tema=TSO
		)
		val inputDokumentSoknadDto = Hjelpemetoder.lagDokumentSoknad(
			skjemanr = kjoreliste,
			tittel = "Kjøreliste",
	...
	fun sendInnKjoreliste_tema_Gitt_Malgruppe() {
		...
		val hoveddokVariantDto = Hjelpemetoder.lagVedlegg(
			...
			erVariant = true,
			opplastingsStatus = OpplastingsStatusDto.LastetOpp,
			vedleggsNavn = "/__files/kjoreliste-NAV-11-12.24B-24052024.json" // tema mangler, malgruppe=MOTDAGPEN
		)
		val inputDokumentSoknadDto = Hjelpemetoder.lagDokumentSoknad(
			skjemanr = kjoreliste,
			tittel = "Kjøreliste",
