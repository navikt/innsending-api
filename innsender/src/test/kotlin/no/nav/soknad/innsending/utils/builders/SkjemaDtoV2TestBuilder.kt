...
class SkjemaDtoV2TestBuilder(
	...
	var hoveddokumentVariant: SkjemaDokumentDtoV2 = SkjemaDokumentDtoV2TestBuilder().asHovedDokumentVariant(skjemanr)
		.build(),
	...
	fun utenBrukerId() = apply { this.brukerId = null }
	fun medAvsender(navn: String) = apply { this.avsender = AvsenderDto(navn = navn) }
	fun utenAvsender() = apply { this.avsender = null }
	fun medVedlegg(vedlegg: SkjemaDokumentDtoV2) =
		apply { vedleggsListe = (vedleggsListe ?: emptyList()) + listOf(vedlegg) }
	...
	fun medFristForEttersendelse(fristForEttersendelse: Long) =
		apply { this.fristForEttersendelse = fristForEttersendelse }
	...
	fun build() = SkjemaDtoV2(
		brukerDto = if (brukerId != null) BrukerDto(id = brukerId!!, idType = BrukerDto.IdType.FNR) else null,
		avsenderId = avsender,
		skjemanr = skjemanr,
		tittel = tittel,
		tema = tema,
