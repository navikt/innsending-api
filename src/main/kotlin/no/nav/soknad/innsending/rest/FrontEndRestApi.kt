...
class FrontEndRestApi {
	...
	fun lagreVedlegg(
		@RequestParam behandlingsId: String,
		@RequestParam skjemanr: String?,
		@RequestParam vedleggsnr: String?,
		@RequestParam tittel: String,
		@RequestParam vedlegg: ByteArray
	...
	@ApiResponses(value = [ApiResponse(responseCode = "200",
			description = "If successful, update of the attachment is stored and an updated version of the VedleggDto is returned."
	)])
	...
	@Operation(
		summary = "Requests delete to one of the application's attachments. Not delete of main attachment will be rejected",
		tags = ["operations"]
	)
	@ApiResponses(
